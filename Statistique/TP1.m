...
base_modelized = swp_img((point_depart_modilized(1)-swp_taille/2:point_depart_modilized(1)+swp_taille/2-1),(point_depart_modilized(2)-swp_taille/2:point_depart_modilized(2)+swp_taille/2-1),:);
...
image_final = modelized_img((taille-1)/2+1:w_mod-(taille-1)/2 , (taille-1)/2+1:l_mod-(taille-1)/2 , :);
